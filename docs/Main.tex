...
% Load custom VS Code-style code highlighting
\input{codestyle-cpp}
...
\ifoot{\textcolor{codegray}{\small Matemáticas + Código}}
\ofoot{\textcolor{codegray}{\small\faGithub\ fourier-epicycles-cpp}}
...
% Title
\begin{center}
    {\fontsize{44}{52}\bfseries\textcolor{ColorBlueText}{Epiciclos de Fourier}}
\end{center}
