...
\title{
    \vspace{-1cm}
    \textcolor{primary}{\rule{\textwidth}{3pt}}\\[0.5cm]
    {\Huge\bfseries\textcolor{dark}{Epiciclos de Fourier}}\\[0.3cm]
    {\Large\textcolor{primary}{Matemáticas + Código de la Animación}}\\[0.3cm]
    \textcolor{primary}{\rule{\textwidth}{3pt}}
}
...
{\Large\textcolor{dark}{\faHeart}\hspace{0.5em}\textbf{Happy Coding!}}
\end{center}
